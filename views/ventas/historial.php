<section class="admin-page ventas-page">
    ...
    <div class="page-heading">
        ...
        <div class="page-actions">
            <a href="/ventas/historial" class="btn btn--soft">Historial de ventas</a>
        </div>
    </div>
    ...
    <?php if($ticket) { ?>
        <section class="data-card ticket-final">
            <div class="data-card__header">
                ...
                <div class="page-actions">
                    <a class="btn btn--soft" href="/ventas/ticket?id=<?php echo (int)$ticket['venta']['id']; ?>">Ver ticket completo</a>
